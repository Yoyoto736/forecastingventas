...
df: ['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'ingresos', 'año', 'mes', 'mes_nombre', 'dia_mes', 'dia_semana',
       'dia_semana_num', 'es_fin_de_semana', 'es_festivo', 'nombre_festivo',
       'es_dia_lectivo', 'trimestre', 'semana_año', 'es_inicio_mes',
       'es_primer_dia_mes', 'es_fin_mes', 'es_ultimo_dia_mes', 'black_friday',
       'cyber_monday', 'es_ultimo_tramo_mes', 'unidades_vendidas_lag_1',
       ...
       'unidades_vendidas_roll_7', 'descuento_porcentaje',
